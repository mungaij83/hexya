...
type BaseMixinSet interface {
	...
	ForceLoad(fields ...loader.FieldName) BaseMixinSet
	...
	Aggregates(fieldNames ...loader.FieldName) []BaseMixinGroupAggregateRow
	...
	ExecuteO2MActions(fieldName loader.FieldName, info *loader.FieldInfo, value interface{}) interface{}
	...
	FieldGet(field loader.FieldName) *loader.FieldInfo
	...
	GroupBy(exprs ...loader.FieldName) BaseMixinSet
	...
	// model are retrieved.
	Load(fields ...loader.FieldName) BaseMixinSet
	...
	NormalizeM2MData(fieldName loader.FieldName, info *loader.FieldInfo, value interface{}) interface{}
	...
	PostProcessFilters(in map[loader.FieldName]loader.Conditioner) map[string][]interface{}
	...
	Read(fields loader.FieldNames) []loader.RecordData
	...
	// the given condition.`,
	SQLFromCondition(c *loader.Condition) (string, loader.SQLParams)
	...
	SortedByField(namer loader.FieldName, reverse bool) BaseMixinSet
...
type BaseMixinDataType interface {
	...
	Get(field loader.FieldName) interface{}
	// Has returns true if a value is set for the given field.
	//
	// The field can be either its name or is JSON name.
	Has(field loader.FieldName) bool
...
//
// It returns the given BaseMixinData so that calls can be chained
func (d BaseMixinData) Set(field loader.FieldName, value interface{}) *loader.ModelData {
...
//
// It returns the given ModelData so that calls can be chained
func (d BaseMixinData) Unset(field loader.FieldName) *loader.ModelData {
...
func (d BaseMixinData) CreateDate() dates.DateTime {
	val := d.ModelData.Get(loader.NewFieldName("CreateDate", "create_date"))
	if !d.Has(loader.NewFieldName("CreateDate", "create_date")) {
...
func (d BaseMixinData) HasCreateDate() bool {
	return d.ModelData.Has(loader.NewFieldName("CreateDate", "create_date"))
}

// SetCreateDate sets the CreateDate field with the given value.
// It returns this BaseMixinData so that calls can be chained.
func (d BaseMixinData) SetCreateDate(value dates.DateTime) BaseMixinData {
	d.ModelData.Set(loader.NewFieldName("CreateDate", "create_date"), value)
	return d
}
...
func (d BaseMixinData) UnsetCreateDate() BaseMixinData {
	d.ModelData.Unset(loader.NewFieldName("CreateDate", "create_date"))
	return d
}
...
func (d BaseMixinData) CreateUID() int64 {
	val := d.ModelData.Get(loader.NewFieldName("CreateUID", "create_uid"))
	if !d.Has(loader.NewFieldName("CreateUID", "create_uid")) {
		return *new(int64)
	}
	return val.(int64)
}
...
func (d BaseMixinData) HasCreateUID() bool {
	return d.ModelData.Has(loader.NewFieldName("CreateUID", "create_uid"))
}

// SetCreateUID sets the CreateUID field with the given value.
// It returns this BaseMixinData so that calls can be chained.
func (d BaseMixinData) SetCreateUID(value int64) BaseMixinData {
	d.ModelData.Set(loader.NewFieldName("CreateUID", "create_uid"), value)
	return d
}
...
func (d BaseMixinData) UnsetCreateUID() BaseMixinData {
	d.ModelData.Unset(loader.NewFieldName("CreateUID", "create_uid"))
	return d
}
...
func (d BaseMixinData) DisplayName() string {
	val := d.ModelData.Get(loader.NewFieldName("DisplayName", "display_name"))
	if !d.Has(loader.NewFieldName("DisplayName", "display_name")) {
		return *new(string)
	}
	return val.(string)
}
...
func (d BaseMixinData) HasDisplayName() bool {
	return d.ModelData.Has(loader.NewFieldName("DisplayName", "display_name"))
}

// SetDisplayName sets the DisplayName field with the given value.
// It returns this BaseMixinData so that calls can be chained.
func (d BaseMixinData) SetDisplayName(value string) BaseMixinData {
	d.ModelData.Set(loader.NewFieldName("DisplayName", "display_name"), value)
	return d
}
...
func (d BaseMixinData) UnsetDisplayName() BaseMixinData {
	d.ModelData.Unset(loader.NewFieldName("DisplayName", "display_name"))
	return d
}
...
func (d BaseMixinData) ID() int64 {
	val := d.ModelData.Get(loader.NewFieldName("ID", "id"))
	if !d.Has(loader.NewFieldName("ID", "id")) {
		return *new(int64)
	}
	return val.(int64)
}
...
func (d BaseMixinData) HasID() bool {
	return d.ModelData.Has(loader.NewFieldName("ID", "id"))
}

// SetID sets the ID field with the given value.
// It returns this BaseMixinData so that calls can be chained.
func (d BaseMixinData) SetID(value int64) BaseMixinData {
	d.ModelData.Set(loader.NewFieldName("ID", "id"), value)
	return d
}
...
func (d BaseMixinData) UnsetID() BaseMixinData {
	d.ModelData.Unset(loader.NewFieldName("ID", "id"))
	return d
}
...
func (d BaseMixinData) LastUpdate() dates.DateTime {
	val := d.ModelData.Get(loader.NewFieldName("LastUpdate", "__last_update"))
	if !d.Has(loader.NewFieldName("LastUpdate", "__last_update")) {
		return *new(dates.DateTime)
	}
	return val.(dates.DateTime)
}
...
func (d BaseMixinData) HasLastUpdate() bool {
	return d.ModelData.Has(loader.NewFieldName("LastUpdate", "__last_update"))
}

// SetLastUpdate sets the LastUpdate field with the given value.
// It returns this BaseMixinData so that calls can be chained.
func (d BaseMixinData) SetLastUpdate(value dates.DateTime) BaseMixinData {
	d.ModelData.Set(loader.NewFieldName("LastUpdate", "__last_update"), value)
	return d
}
...
func (d BaseMixinData) UnsetLastUpdate() BaseMixinData {
	d.ModelData.Unset(loader.NewFieldName("LastUpdate", "__last_update"))
	return d
}
...
func (d BaseMixinData) WriteDate() dates.DateTime {
	val := d.ModelData.Get(loader.NewFieldName("WriteDate", "write_date"))
	if !d.Has(loader.NewFieldName("WriteDate", "write_date")) {
		return *new(dates.DateTime)
	}
	return val.(dates.DateTime)
}
...
func (d BaseMixinData) HasWriteDate() bool {
	return d.ModelData.Has(loader.NewFieldName("WriteDate", "write_date"))
}

// SetWriteDate sets the WriteDate field with the given value.
// It returns this BaseMixinData so that calls can be chained.
func (d BaseMixinData) SetWriteDate(value dates.DateTime) BaseMixinData {
	d.ModelData.Set(loader.NewFieldName("WriteDate", "write_date"), value)
	return d
}
...
func (d BaseMixinData) UnsetWriteDate() BaseMixinData {
	d.ModelData.Unset(loader.NewFieldName("WriteDate", "write_date"))
	return d
}
...
func (d BaseMixinData) WriteUID() int64 {
	val := d.ModelData.Get(loader.NewFieldName("WriteUID", "write_uid"))
	if !d.Has(loader.NewFieldName("WriteUID", "write_uid")) {
		return *new(int64)
	}
	return val.(int64)
}
...
func (d BaseMixinData) HasWriteUID() bool {
	return d.ModelData.Has(loader.NewFieldName("WriteUID", "write_uid"))
}

// SetWriteUID sets the WriteUID field with the given value.
// It returns this BaseMixinData so that calls can be chained.
func (d BaseMixinData) SetWriteUID(value int64) BaseMixinData {
	d.ModelData.Set(loader.NewFieldName("WriteUID", "write_uid"), value)
	return d
}
...
func (d BaseMixinData) UnsetWriteUID() BaseMixinData {
	d.ModelData.Unset(loader.NewFieldName("WriteUID", "write_uid"))
	return d
}

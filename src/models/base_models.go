...
type HexyaBaseModel struct {
	...
	CreateDate  time.Time `json:"create_date" gorm:"autoCreateTime:true" hexya:"type=datetime;display_name=Created On;noCopy"`
	...
	WriteDate   time.Time `json:"write_date" gorm:"autoUpdateTime:true" hexya:"type=datetime;display_name=Updated On;noCopy"`
	LastUpdate  time.Time `json:"__last_update" gorm:"autoUpdateTime:true" hexya:"type=datetime;display_name=Updated On;noCopy"`

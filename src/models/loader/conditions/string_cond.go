...
func (c StringConditionField) EqualsFunc(arg func(models.RecordSet) string) Condition {
	return Condition{
		Condition: c.ConditionField.Equals(arg),
	}
}
...
// The function will be evaluated when the query is performed and
// it will be given the RecordSet on which the query is made as parameter
func (c StringConditionField) NotEqualsFunc(arg func(models.RecordSet) string) Condition {
	return Condition{
		Condition: c.ConditionField.NotEquals(arg),
	}
}
...
// The function will be evaluated when the query is performed and
// it will be given the RecordSet on which the query is made as parameter
func (c StringConditionField) GreaterFunc(arg func(models.RecordSet) string) Condition {
	return Condition{
		Condition: c.ConditionField.Greater(arg),
	}
}
...
// The function will be evaluated when the query is performed and
// it will be given the RecordSet on which the query is made as parameter
func (c StringConditionField) GreaterOrEqualFunc(arg func(models.RecordSet) string) Condition {
	return Condition{
		Condition: c.ConditionField.GreaterOrEqual(arg),
	}
}
...
// The function will be evaluated when the query is performed and
// it will be given the RecordSet on which the query is made as parameter
func (c StringConditionField) LowerFunc(arg func(models.RecordSet) string) Condition {
	return Condition{
		Condition: c.ConditionField.Lower(arg),
	}
}
...
// The function will be evaluated when the query is performed and
// it will be given the RecordSet on which the query is made as parameter
func (c StringConditionField) LowerOrEqualFunc(arg func(models.RecordSet) string) Condition {
	return Condition{
		Condition: c.ConditionField.LowerOrEqual(arg),
	}
}
...
// The function will be evaluated when the query is performed and
// it will be given the RecordSet on which the query is made as parameter
func (c StringConditionField) LikeFunc(arg func(models.RecordSet) string) Condition {
	return Condition{
		Condition: c.ConditionField.Like(arg),
	}
}
...
// The function will be evaluated when the query is performed and
// it will be given the RecordSet on which the query is made as parameter
func (c StringConditionField) ContainsFunc(arg func(models.RecordSet) string) Condition {
	return Condition{
		Condition: c.ConditionField.Contains(arg),
	}
}
...
// The function will be evaluated when the query is performed and
// it will be given the RecordSet on which the query is made as parameter
func (c StringConditionField) NotContainsFunc(arg func(models.RecordSet) string) Condition {
	return Condition{
		Condition: c.ConditionField.NotContains(arg),
	}
}
...
// The function will be evaluated when the query is performed and
// it will be given the RecordSet on which the query is made as parameter
func (c StringConditionField) IContainsFunc(arg func(models.RecordSet) string) Condition {
	return Condition{
		Condition: c.ConditionField.IContains(arg),
	}
}
...
// The function will be evaluated when the query is performed and
// it will be given the RecordSet on which the query is made as parameter
func (c StringConditionField) NotIContainsFunc(arg func(models.RecordSet) string) Condition {
	return Condition{
		Condition: c.ConditionField.NotIContains(arg),
	}
}
...
// The function will be evaluated when the query is performed and
// it will be given the RecordSet on which the query is made as parameter
func (c StringConditionField) ILikeFunc(arg func(models.RecordSet) string) Condition {
	return Condition{
		Condition: c.ConditionField.ILike(arg),
	}
}
...
// The function will be evaluated when the query is performed and
// it will be given the RecordSet on which the query is made as parameter
func (c StringConditionField) InFunc(arg func(models.RecordSet) []string) Condition {
	return Condition{
		Condition: c.ConditionField.In(arg),
	}
}
...
// The function will be evaluated when the query is performed and
// it will be given the RecordSet on which the query is made as parameter
func (c StringConditionField) NotInFunc(arg func(models.RecordSet) []string) Condition {
	return Condition{
		Condition: c.ConditionField.NotIn(arg),
	}
}
...
// The function will be evaluated when the query is performed and
// it will be given the RecordSet on which the query is made as parameter
func (c StringConditionField) ChildOfFunc(arg func(models.RecordSet) string) Condition {
	return Condition{
		Condition: c.ConditionField.ChildOf(arg),
	}
}

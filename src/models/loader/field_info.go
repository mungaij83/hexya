...
type FieldInfo struct {
	...
	Name             string                                           `json:"-"`
	JSON             string                                           `json:"-"`
	ReadOnlyFunc     func(Environment) (bool, conditions.Conditioner) `json:"-"`
	RequiredFunc     func(Environment) (bool, conditions.Conditioner) `json:"-"`
	InvisibleFunc    func(Environment) (bool, conditions.Conditioner) `json:"-"`
...
type OnchangeResult struct {
	...
	Filters map[conditions.FieldName]conditions.Conditioner `json:"domain"`
}

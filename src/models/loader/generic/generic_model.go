...
type ModelDefinition[M TableModel] struct {
	*models.Model
}
...
// CompanySet instance.
func (md ModelDefinition[M]) Create(env models.Environment, data m.CompanyData) m.CompanySet {
...
func (md ModelDefinition[M]) Search(env models.Environment, cond q.CompanyCondition) m.CompanySet {
	return company.CompanySet{
...
func (md ModelDefinition) Browse(env models.Environment, ids []int64) m.CompanySet {
	return company.CompanySet{
...
func (md ModelDefinition) BrowseOne(env models.Environment, id int64) m.CompanySet {
	return company.CompanySet{
...
func (md ModelDefinition) NewData(fm ...models.FieldMap) m.CompanyData {
	return models.NewModelData(Company(), fm...)
}

// Fields returns the Field Collection of the Company Model
func (md ModelDefinition) Fields() company.FieldsCollection {
...
func (md ModelDefinition) Underlying() *models.Model {
	return md.Model
}
...
func (md ModelDefinition) Coalesce(lst ...m.CompanySet) m.CompanySet {
...
// its NewSet() function.
func NewModelDefinition(mdl *models.Model) ModelDefinition {
